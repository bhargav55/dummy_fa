module warpgate::swap {
    ...
    public fun swap_x_to_exact_y(
        ...
        let swap_info = borrow_global_mut<SwapInfo>(RESOURCE_ACCOUNT);
        let denom = FEE_DENOMINATOR - swap_info.mm_fee;
        let amount_in_total = (amount_in as u128) * FEE_DENOMINATOR / denom;
        let mm_fee_amount = amount_in_total - (amount_in as u128);
        debug::print(&amount_in_total);
        debug::print(&mm_fee_amount);
